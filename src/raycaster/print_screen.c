...
/*   Updated: 2024/05/25 15:28:28 by flaviobiond      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
the top-left corner and moving row by row
...
-it checks the corresponding value in the game->pixels array.
	...
	if the current pixel is in the upper half of the screen 
	(h < game->win_height / 2).
		-If it is, it sets the color of the pixel to the ceiling color
		(game->type[CEALING].hex).
